...
background.src = "http://blogs.slj.com/afuse8production/files/2018/01/QUIET4.jpg";
var mouseX = width/2;
...
function Gold() {
  ...
  var img = new Image();
  img.src = 'https://cdn0.iconfinder.com/data/icons/sweet-and-candies-1/64/pudding-food-sweet-dessert-gelatine-128.png';
  this.img = img;
...
function Ghost() {
  var img = new Image();
  img.src = 'https://cdn.clipart.email/45b92b48abbbdd1dc1f546ccc7929213_baby-monkey-svg-scrapbook-cut-file-cute-clipart-files-for-_432-432.png';
  this.img = img;
  this.sizeX = img.naturalWidth*0.5;
  this.sizeY = img.naturalHeight*0.5;
